<div>
    ...
    <section class="text-gray-600 bg-white body-font">
        <div class="container px-5 pb-24 mx-auto">
            <div class="inline-flex items-center justify-center w-full mt-14">
                <hr class="w-96 h-1 my-8 bg-indigo-500 border-0 rounded dark:bg-gray-900">
            ...
            <div class="text-center">
                <div class="grid grid-cols-2 mx-auto w-3/5 ">

                    @foreach ($documents as $item)
                    <a href=""   class="bg-indigo-400 m-2 p-2  flex rounded-md text-white hover:bg-indigo-200">
    ...
    <section>
        ...
        <div class="text-gray-600 bg-gray-100 body-font">
            <div class="container pt-9  pb-24 mx-auto">
                <div class="grid grid-cols-3 gap-x-3">
                    <div>
                        ...
                        <div
                            ...
                            <a href="#">
                                <img class="rounded-t-lg" src="http://via.placeholder.com/1920x1080" alt="" />
                            </a>

                            <div class="flex justify-between items-center px-5 pt-5 pb-2 text-gray-500">
                                ...
                                <span class="text-sm">12/12/2012</span>
                            </div>
                            <div class="px-5 pb-5">
                                <a href="#">
                                ...
                                <a href="#"
                                    class="inline-flex items-center px-3 py-2 text-base font-medium text-center text-white bg-indigo-700 rounded-lg hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
                                    Read more
    ...
    <section class="bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Somos la seguridad de Todos</h1>
    ...
    <section>
        <div class="inline-flex items-center justify-center bg-white w-full pt-14">
            <hr class="w-96 h-1 my-8 bg-indigo-500 border-0 rounded dark:bg-gray-900">
            ...
            <div class="container pt-9  pb-24 mx-auto">
                <div class="grid grid-cols-3 gap-x-3">
                    <div class=""> 
                        ...
                        <iframe width="" height="" class="w-full aspect-video" src="https://www.youtube.com/embed/PbBLzVRb_GI?si=n3FS2tBYVLmQrCRX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
