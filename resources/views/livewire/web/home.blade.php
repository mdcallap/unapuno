<div>
        ...
        <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
            ...
            @foreach ($sliders as $item)
                <button type="button" class="w-3 h-3 rounded-full" aria-current="true"
                    aria-label="Slide {{ $item->id + 1 }}" data-carousel-slide-to="{{ $item->id }}"></button>
            @endforeach
        </div>
        <!-- Slider controls -->
        <button type="button"
    ...
    <section class="text-gray-600 bg-white body-font">
        <div class="container px-5 pb-24 mx-auto">
            ...
            <div class="text-center">
                <div class="grid grid-cols-1  lg:grid-cols-2 mx-auto lg:w-3/5 ">

                    @foreach ($documents as $item)
                        <a href="{{route('web.show.document',$item->id)}}" class="bg-indigo-400 m-2 p-2 text-center  flex rounded-md text-white hover:bg-indigo-200">
                            <svg class="w-10 h-10 mx-5 text-white dark:text-white" aria-hidden="true"
            ...
            <div class="flex  space-y-4 flex-row justify-center sm:space-y-0 mt-6">
    ...
    <section>
        ...
        <div class="text-gray-600 bg-gray-100 body-font">
            <div class="container pt-9  pb-24 mx-auto">
                ...
                <div
                    class="mx-10  mt-10 grid max-w-2xl grid-cols-1 gap-4    border-t border-gray-200  lg:mx-0 lg:max-w-none lg:grid-cols-4">
                    ...
                    <article class="flex max-w-xl flex-col items-start justify-between">
                        ...
                        <a href="{{route('web.show.post',$post->id)}}">
                            ...
                            <img src="{{asset('storage/'.$post->file)}}"
                                class="h-56 max-w-full object-contain" alt="">
                ...
                <div class="flex  space-y-4 flex-row justify-center sm:space-y-0 mt-10">
    ...
    <section
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 ">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
                Seguridad y Salud en el Trabajo</h1>
    ...
    <section>
        ...
        <div class="text-gray-600 bg-white body-font">
            <div class="container pt-9  pb-24 mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-y-3 lg:gap-x-3">
                    ...
                    <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
                        <div
                            ...
                            <a href="https://www.regionpuno.gob.pe/">
                                <img src="images/gobierno-regional.png" class="img-fluid" alt="">
                            </a>
...
@push('js')
<script>
       var elemento = document.getElementsByTagName('iframe');
       elemento.className = "w-full aspect-video";
